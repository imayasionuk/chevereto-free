...
namespace G {
    ...
    function linkify_safe($text, $options = [])
    {
        ...
        return linkify(htmlspecialchars($text, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401), $options);
    }
    ...
    function is_url($string)
    {
        ...
        if (strlen($string) !== strlen(mb_convert_encoding($string, 'UTF-8', 'ISO-8859-1'))) {
    ...
    function name_unique_file($path, $method, $filename)
    {
